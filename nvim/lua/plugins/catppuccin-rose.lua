    ...
    opts = {
      ...
      custom_highlights = function(colors)
        return {
          ...
          RenderMarkdownH1Bg = { bg = "#5a474b" },
          RenderMarkdownH2Bg = { bg = "#4f3f5c" },
          RenderMarkdownH3Bg = { bg = "#37445f" },
          RenderMarkdownH4Bg = { bg = "#474a60" },
          RenderMarkdownH5Bg = { bg = "#5c513a" },
          RenderMarkdownH6Bg = { bg = "#34504c" },
